...
class VendorResource extends BaseResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'payables_account' => new ChartOfAccountResource($this->whenLoaded('payablesAccount')),
            'purchase_account' => new ChartOfAccountResource($this->whenLoaded('purchaseAccount')),
            'purchase_discount_account' => new ChartOfAccountResource($this->whenLoaded('purchaseDiscountAccount')),
            'purchase_return_account' => new ChartOfAccountResource($this->whenLoaded('purchaseReturnAccount')),
